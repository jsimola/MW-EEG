# MW task by Jaana Simola

# This task has been previously used by Konishi et al., 2015 and 2017

# --------------- 07.06.2019 -----------------------
#  First version: 0-back
# -------------------------------------------------

# --------------- 11.06.2019 -----------------------
#  Both conditions (0-back and 1-back) added
# -------------------------------------------------

# --------------- 12.06.2019 -----------------------
#  ToDo:
#  - Number of trials and blocks needs to be decided
#  - Stimulus durations (?)
#  - Counterbalancing of colour/condition, condition order
#	- Thought probes
#  Done:
#  - "SWITCH" -message
# -------------------------------------------------
...
# --------------- 20.06.2019 -----------------------
# 	Control that in 1-back task the target is not 
#  a shape that wasn't present in the previous stimulus
# -------------------------------------------------

# --------------- 27.09.2019 -----------------------
# 	Match 0-back and 1-back tasks in terms of ISIs 
#  and trial repetitions 
# -------------------------------------------------

# --------------- 31.10.2019 -----------------------
#  Resting state (1 min) added to the beginning
#  Port codes added to thought probes
#  Response mapping to thought probes improved
# --------------------------------------------------
...
trial { 
	trial_duration = 2000 ;
	#trial_type = first_response; #specific_response;
	#terminator_button = 7; # enter
	picture {
		text { caption = 
		"Thank you!";
		font_color = 0,0,0;
